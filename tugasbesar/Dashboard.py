...
class Dashboard:
    def __init__(self):
        ...
        self.__data = None
        self.__level = None
        self.image_Path = 'C:/tugasbesar/komik.jpg'  # Gunakan garis miring terbalik atau raw string
        ...
        self.admin_menu.add_command(label='Admin-1', command=lambda: self.new_window("Aplikasi Rental Komik", FormTestkomik))
